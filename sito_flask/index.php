            ...
            <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
                ...
                <ul class="w3-ul w3-border w3-white w3-text-grey">
                    ...
                    <?php
                        ...
                        foreach ($Tour::get_months() as $mese){
                            ?>
                                <li class="w3-padding"><?php echo date("M", mktime(0, 0, 0, $mese["mese"], 1, 2021));?><span class="w3-tag w3-red w3-margin-left"><?php echo $mese["tot"];?></span></li>
                            <?php
                        }
